...
test('each learner starts from day one on their own enrollment date', () => {
  const newLearner = learner('2026-08-20T12:00:00.000Z');

  assert.equal(getArabicCourseDay(newLearner, new Date('2026-08-20T17:59:59.999Z')), 1);
});
