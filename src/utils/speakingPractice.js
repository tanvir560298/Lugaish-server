...
const SPEAKING_SCORING_STRATEGIES = new Set(['keywords', 'greeting', 'name', 'wellbeing', 'origin', 'nationality', 'question_reading', 'english_first_meeting', 'english_self_introduction']);
