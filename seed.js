...
const englishLessons = Array.from({ length: 30 }, (_, index) => {
  ...
  if (day % 2 !== 0) {
    ...
    const quizQuestions = day === 2 ? [
      ...
      { question: 'Calculate the annual fixed asset ________ expense.', options: ['Depresiation', 'Depriciation', 'Depreciation', 'Depretiation'], correctAnswer: 2, explanation: "'Depreciation' is the correct spelling for reduction in value over time." },
      { question: 'The auditor verified the year-end raw material ________.', options: ['Inventry', 'Inventory', 'Inventary', 'Inventree'], correctAnswer: 1, explanation: "'Inventory' is the correct spelling for stock of goods." },
      { question: 'Check the total owner\'s ________ balance in the sheet.', options: ['Equity', 'Equitty', 'Equitey', 'Equety'], correctAnswer: 0, explanation: "'Equity' is the correct spelling for ownership interest." },
      { question: 'Send an urgent payment reminder to the trade ________.', options: ['Detor', 'Debter', 'Debtor', 'Debttor'], correctAnswer: 2, explanation: "'Debtor' is the correct spelling for a person or company that owes money." },
      { question: 'Borrowing money at a high ________ rate increases cost.', options: ['Intrest', 'Interest', 'Interist', 'Interst'], correctAnswer: 1, explanation: "'Interest' is the correct spelling for charge for borrowing money." },
      { question: 'The company expects a higher ________ on investment.', options: ['Retirn', 'Return', 'Retturn', 'Returne'], correctAnswer: 1, explanation: "'Return' is the correct spelling for profit earned from investment." },
      { question: 'Prepare a quarterly cash flow ________ for management.', options: ['Forcast', 'Forecaste', 'Forecast', 'Forcaust'], correctAnswer: 2, explanation: "'Forecast' is the correct spelling for predicting future trends." },
      { question: 'Every investment carries an element of financial ________.', options: ['Risc', 'Risk', 'Riske', 'Risck'], correctAnswer: 1, explanation: "'Risk' is the correct spelling for danger or hazard." },
      { question: 'Record the daily ledger ________ accurately.', options: ['Transacktion', 'Transation', 'Transaction', 'Tranzaction'], correctAnswer: 2, explanation: "'Transaction' is the correct spelling for business event or transfer." },
      { question: 'The business negotiated terms with its primary ________.', options: ['Creditor', 'Crediter', 'Creaditor', 'Credytor'], correctAnswer: 0, explanation: "'Creditor' is the correct spelling for a person or company to whom money is owed." }
    ] : day === 24 ? [
      { question: 'The bank approved a formal loan ________ for the company.', options: ['Facillity', 'Facility', 'Fasility', 'Facilaty'], correctAnswer: 1, explanation: "'Facility' is the correct spelling for amenity or service." },
      { question: 'The company issued ordinary shares to raise ________.', options: ['Equitty', 'Equitey', 'Equity', 'Equety'], correctAnswer: 2, explanation: "'Equity' is the correct spelling for stock or assets." },
      { question: 'Check the total bank ________ limit before withdrawing.', options: ['Overdraft', 'Over-draft', 'Overdrafte', 'Overdrauft'], correctAnswer: 0, explanation: "'Overdraft' is the correct spelling for a deficit in a bank account." },
      { question: 'Review the loan ________ schedule provided by the bank.', options: ['Repayment', 'Repayement', 'Re-payment', 'Repaymint'], correctAnswer: 0, explanation: "'Repayment' is the correct spelling for paying back money." },
      { question: 'We need to develop a solid cost-reduction ________.', options: ['Stratejy', 'Strategy', 'Stratigy', 'Strategie'], correctAnswer: 1, explanation: "'Strategy' is the correct spelling for plan of action." },
      { question: 'The board will ________ the new compliance policies.', options: ['Implement', 'Impliment', 'Implemant', 'Implemente'], correctAnswer: 0, explanation: "'Implement' is the correct spelling for putting a decision or plan into effect." },
      { question: 'Our team will ________ the annual key performance indicators.', options: ['Moniter', 'Monitor', 'Monnitor', 'Mawnitor'], correctAnswer: 1, explanation: "'Monitor' is the correct spelling for keeping under systematic review." },
...
const arabicLessons = [
  ...
  },
  {
    ...
    "quiz": [
      {
        "question": "“أَرِيكَةٌ” (Ariikatun) শব্দের সঠিক বাংলা অর্থ কোনটি?",
        "options": ["সোফা", "কার্পেট", "খাট", "পর্দা"],
        "correctAnswer": 0,
        "explanation": "“أَرِيكَةٌ” (Ariikatun) অর্থ সোফা।"
      },
      {
        "question": "“ফ্রিজ” এবং “কার্পেট” এর সঠিক আরবী শব্দযুগল কোনটি?",
        "options": ["ثَلَّاجَةٌ - سَجَّادَةٌ", "سَرِيرٌ - سِتَارَةٌ", "أَرِيكَةٌ - ثَلَّاجَةٌ", "غُرْفَةٌ - سَجَّادَةٌ"],
        "correctAnswer": 0,
        "explanation": "“ثَلَّاجَةٌ” (Thallaajatun) অর্থ ফ্রিজ এবং “سَجَّادَةٌ” (Sajjaadatun) অর্থ কার্পেট।"
      },
      {
        "question": "“غُرْفَةُ النَّوْمِ” এবং “غُرْفَةُ الْجُلُوسِ” এর বাংলা অর্থ যথাক্রমে কী?",
        "options": ["শোবার ঘর ও বসার ঘর", "বসার ঘর ও খাবার ঘর", "পড়ার ঘর ও শোবার ঘর", "রান্নাঘর ও বসার ঘর"],
        "correctAnswer": 0,
        "explanation": "“غُرْفَةُ النَّوْمِ” অর্থ শোবার ঘর এবং “غُرْفَةُ الْجُلُوسِ” অর্থ বসার ঘর।"
      },
      {
        "question": "আরবী ব্যাকরণে যার গুণ বা বৈশিষ্ট্য বর্ণনা করা হয় তাকে কী বলা হয়?",
        "options": ["مَنْعُوت (Man'ut)", "نَعْت (Na't)", "مُضَاف (Mudaf)", "حَرْفُ جَرّ (Harf-e-Jar)"],
        "correctAnswer": 0,
        "explanation": "যার গুণ বলা হয় তাকে “مَنْعُوت” (Man'ut বা বিশেষ্য) এবং গুণবাচক শব্দকে “نَعْت” (Na't বা বিশেষণ) বলা হয়। আরবিতে Man'ut আগে এবং Na't পরে আসে।"
      },
      {
        "question": "“একটি সুন্দর সোফা” এর সঠিক আরবী অনুবাদ কোনটি?",
        "options": ["أَرِيكَةٌ جَمِيلٌ", "أَرِيكَةٌ جَمِيلَةٌ", "اَلْأَرِيكَةُ جَمِيلَةٌ", "أَرِيكَةٌ كَبِيرٌ"],
        "correctAnswer": 1,
        "explanation": "“أَرِيكَةٌ” শব্দটি স্ত্রীবাচক, তাই এর বিশেষণও স্ত্রীবাচক হয়ে “أَرِيكَةٌ جَمِيلَةٌ” হবে।"
      },
      {
        "question": "“নতুন বাড়িটি” (The new house) এর সঠিক আরবী রূপ কোনটি?",
        "options": ["بَيْتٌ جَدِيدٌ", "اَلْبَيْتُ جَدِيدٌ", "اَلْبَيْتُ الْجَدِيدُ", "بَيْتُ الْجَدِيدِ"],
        "correctAnswer": 2,
        "explanation": "বিশেষ্য নির্দিষ্ট (ال-যুক্ত) হলে বিশেষণও নির্দিষ্ট (ال-যুক্ত) হতে হয়। তাই “নতুন বাড়িটি” হবে “اَلْبَيْتُ الْجَدِيدُ”。"
      },
      {
        "question": "দোকানে বিক্রেতা ক্রেতাকে স্বাগত জানিয়ে কী বলে সহায়তা করতে চেয়েছেন?",
        "options": ["أَيَّ خِدْمَةٍ؟", "مَا اسْمُكَ؟", "مِنْ أَيْنَ أَنْتَ؟", "كَيْفَ حَالُكَ؟"],
        "correctAnswer": 0,
        "explanation": "দোকানে বা সেবায় সংক্ষিপ্ত মার্জিত প্রশ্ন হিসেবে “أَيَّ خِدْمَةٍ؟” (কী সেবা করতে পারি?) ব্যবহৃত হয়।"
      },
      {
        "question": "“আমি একটি খাট এবং একটি পর্দা চাই।” বাক্যটির সঠিক আরবী কোনটি?",
        "options": ["أُرِيدُ سَرِيرٌ وَسِتَارَةٌ", "أُرِيدُ سَرِيرًا وَسِتَارَةً", "أُرِيدُ السَّرِيرِ وَالسِّتَارَةِ", "أُرِيدُ بَعْضَ السَّرِيرِ"],
        "correctAnswer": 1,
        "explanation": "“أُرِيدُ” (আমি চাই) এর অবজেক্ট হওয়ায় উভয়ের শেষে তানউইন ফাতহাহ (যবর) হয়ে “أُرِيدُ سَرِيرًا وَسِتَارَةً” হবে।"
      },
      {
        "question": "“এটি একটি সহজ পাঠ।” এর শূন্যস্থানে সঠিক Na't কোনটি বসবে? — “هٰذَا دَرْسٌ ............”",
        "options": ["سَهْلَةٌ", "اَلسَّهْلُ", "سَهْلٌ", "سَهْلٍ"],
        "correctAnswer": 2,
        "explanation": "“دَرْسٌ” পুরুষবাচক ও অনির্দিষ্ট তানউইনযুক্ত, তাই এর Na't হবে “سَهْلٌ”। পূর্ণ বাক্য: “هٰذَا دَرْسٌ سَهْلٌ”。"
      },
      {
        "question": "“ব্যাগটি কোথায়? সেটি টেবিলের নিচে।” এর সঠিক আরবী কোনটি?",
        "options": ["أَيْنَ الْحَقِيبَةُ؟ هُوَ عَلَى الْمَكْتَبِ", "أَيْنَ الْحَقِيبَةُ؟ هِيَ تَحْتَ الْمَكْتَبِ", "أَيْنَ الْقَلَمُ؟ هُوَ فِي الْحَقِيبَةِ", "أَيْنَ الْمَكْتَبُ؟ هُوَ تَحْتَ الْحَقِيبَةِ"],
        "correctAnswer": 1,
        "explanation": "“اَلْحَقِيبَةُ” (ব্যাগ) স্ত্রীবাচক হওয়ায় এর সর্বনাম “هِيَ” এবং “تَحْتَ الْمَكْتَبِ” অর্থ টেবিলের নিচে। তাই সঠিক উত্তর “أَيْنَ الْحَقِيبَةُ؟ هِيَ تَحْتَ الْمَكْتَبِ”。"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "description": "Practice attached pronouns, daily life vocabulary, and dialogue from Class 09.",
    ...
    "quiz": [
      {
        "question": "“زَمِيلٌ” (Zamiilun) শব্দের সঠিক বাংলা অর্থ কোনটি?",
        "options": [
          "সহপাঠী / সহকর্মী",
          "শিক্ষক",
          "ডাক্তার",
        ...
        "correctAnswer": 0,
        "explanation": "“زَمِيلٌ” (Zamiilun) অর্থ সহপাঠী বা সহকর্মী।"
      },
      {
        "question": "“لُغَةٌ سَهْلَةٌ” (Lughatun sahlatun) এর সঠিক বাংলা অনুবাদ কোনটি?",
        "options": [
          "সহজ ভাষা",
          "কঠিন ভাষা",
          "নতুন বই",
        ...
        "correctAnswer": 0,
        "explanation": "“لُغَةٌ” অর্থ ভাষা এবং “سَهْلَةٌ” অর্থ সহজ (স্ত্রীবাচক)। তাই “لُغَةٌ سَهْلَةٌ” মানে সহজ ভাষা।"
      },
      {
        "question": "আরবীতে কোনো বিশেষ্যের শেষে আমার বোঝাতে “ي” যুক্ত হলে পূর্বের অক্ষরের হরকত কী হয়? যেমন: “اِسْمٌ + ي”",
        "options": [
          "যম্মা (পেশ)",
          "কাসরাহ (যের)",
          "ফাতহাহ (যবর)",
        ...
        "correctAnswer": 1,
        "explanation": "কোনো বিশেষ্যের শেষে “ي” (আমার) যুক্ত হলে পূর্বের অক্ষরে কাসরাহ (যের) ধ্বনি হয়ে “اِسْمِي” (Ismii - আমার নাম) গঠিত হয়।"
      },
      {
        "question": "“তোমার বই (পুরুষ)” এবং “তার বাড়ি (পুরুষ)” এর সঠিক আরবী রূপ যথাক্রমে কোনটি?",
        "options": [
          "كِتَابُكَ - بَيْتُهُ",
          "كِتَابِي - بَيْتُكِ",
          "كِتَابُهَا - بَيْتِي",
        ...
        "correctAnswer": 0,
        "explanation": "পুরুষবাচক “তোমার” বোঝাতে “كَ” (كِتَابُكَ) এবং পুরুষবাচক “তার” বোঝাতে “هُ” (بَيْتُهُ) ব্যবহৃত হয়।"
      },
      {
        "question": "স্ত্রীবাচকে “তার মা” বোঝাতে সংযুক্ত সর্বনামসহ সঠিক আরবী কোনটি?",
        "options": [
          "أُمُّهُ",
          "أُمُّهَا",
          "أُمِّي",
        ...
        "correctAnswer": 1,
        "explanation": "স্ত্রীবাচক “তার” বোঝাতে “هَا” সংযুক্ত হয়ে “أُمُّهَا” (Ummuhaa) হয়।"
      },
      {
        "question": "“أَيْنَ تُصَلِّي الصَّلَوَاتِ الْخَمْسَ؟” বাক্যে “تُصَلِّي” ক্রিয়াটি দ্বারা কী বোঝানো হয়েছে?",
        "options": [
          "আপনি নামাজ পড়েন",
          "আমি নামাজ পড়ি",
          "সে নামাজ পড়ে",
        ...
        "correctAnswer": 0,
        "explanation": "বর্তমান কালের ক্রিয়ায় শুরুতে “تُـ” থাকায় অর্থ হয়েছে “আপনি নামাজ পড়েন” বা “তুমি নামাজ পড়ো”。"
      },
      {
        "question": "“আমি বিলাল মসজিদে নামাজ পড়ি।” বাক্যটির সঠিক আরবী কোনটি?",
        "options": [
          "أُصَلِّي فِي مَسْجِدِ بِلَالٍ",
          "تُصَلِّي فِي مَسْجِدِ بِلَالٍ",
          "يُصَلِّي فِي بَيْتِ بِلَالٍ",
          "أُصَلِّي مَعَ بِلَالٍ"
        ],
        "correctAnswer": 0,
        "explanation": "নিজের কাজ বোঝাতে ক্রিয়ার শুরুতে “أُ” এসে “أُصَلِّي” হয় এবং “فِي مَسْجِدِ بِلَالٍ” অর্থ বিলাল মসজিদে। পূর্ণ বাক্য: “أُصَلِّي فِي مَسْجِدِ بِلَالٍ”。"
      },
      {
        "question": "“يَسْتَيْقِظُ مُبَكِّرًا” বাক্যটির সঠিক বাংলা অর্থ কী?",
        "options": [
          "সে দেরিতে ঘুম থেকে জাগে",
          "সে খুব ভোরে / তাড়াতাড়ি ঘুম থেকে জাগে",
          "সে মসজিদে যায়",
          "সে আজান শোনে"
        ],
        "correctAnswer": 1,
        "explanation": "“يَسْتَيْقِظُ” অর্থ সে জাগে এবং “مُبَكِّرًا” অর্থ তাড়াতাড়ি বা খুব ভোরে। তাই অর্থ: “সে খুব ভোরে / তাড়াতাড়ি ঘুম থেকে জাগে”。"
      },
      {
        "question": "“لَا أَسْمَعُ الْأَذَانَ” (Laa asma'ul-adhaana) বাক্যটিতে “لَا” এর ব্যাকরণিক ভূমিকা কী?",
        "options": [
          "প্রশ্ন তৈরি করা",
          "বর্তমান কালের ক্রিয়াকে নাকরণ করা (আমি আজান শুনি না)",
          "আদেশ প্রদান করা",
          "অতীত কালের ক্রিয়া গঠন করা"
        ],
        "correctAnswer": 1,
        "explanation": "“أَسْمَعُ” মানে আমি শুনি, আর শুরুতে “لَا” যুক্ত হয়ে বর্তমান ক্রিয়াকে নাকরণ করে অর্থ প্রকাশ করে “আমি আজান শুনি না / শুনতে পাই না”。"
      },
      {
        "question": "“ضَعِ الْمُنَبِّهَ بِجَانِبِكَ” বাক্যটির সঠিক বাংলা অর্থ কোনটি?",
        "options": [
          "আপনার পাশে অ্যালার্ম ঘড়িটি রাখুন",
          "অ্যালার্ম ঘড়িটি টেবিলের উপরে রাখুন",
          "আপনার ভাই দেরিতে জেগেছে",
          "আপনি কি আজান শুনেছেন?"
        ],
        "correctAnswer": 0,
        "explanation": "“ضَعْ” অর্থ রাখুন (আদেশসূচক), “الْمُنَبِّهَ” অর্থ অ্যালার্ম ঘড়ি এবং “بِجَانِبِكَ” অর্থ আপনার পাশে। সুতরাং অর্থ: “আপনার পাশে অ্যালার্ম ঘড়িটি রাখুন”。"
      }
    ]
  },
  {
